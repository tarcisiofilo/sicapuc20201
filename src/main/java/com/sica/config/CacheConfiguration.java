...
createCache(cm, com.sica.domain.NivelIncidente.class.getName() + ".incidentes");
createCache(cm, com.sica.domain.MinaOperacao.class.getName() + ".minaOperacaos");
createCache(cm, com.sica.domain.AreaSusceptivel.class.getName() + ".areaSusceptivels");
createCache(cm, com.sica.domain.Familia.class.getName() + ".familias");
createCache(cm, com.sica.domain.Ativo.class.getName() + ".ativos");
createCache(cm, com.sica.domain.Ativo.class.getName() + ".incidentes");
createCache(cm, com.sica.domain.NivelIncidente.class.getName() + ".nivelIncidentes");
