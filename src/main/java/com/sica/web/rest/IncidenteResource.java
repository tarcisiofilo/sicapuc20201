...
public class IncidenteResource {
    ...
    public ResponseEntity<Incidente> createIncidente(@Valid @RequestBody Incidente incidente) throws URISyntaxException {
    ...
    public ResponseEntity<Incidente> updateIncidente(@Valid @RequestBody Incidente incidente) throws URISyntaxException {
