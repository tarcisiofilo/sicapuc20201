...
import { IIncidente, Incidente, OrigemIncidente } from 'app/shared/model/incidente.model';
...
describe('Service Tests', () => {
  describe('Incidente Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Incidente', async () => {
      ...
      it('should update a Incidente', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of Incidente', async () => {
        const returnedFromService = Object.assign(
          {
            identificacao: 'BBBBBB',
            origem: 'BBBBBB',
      ...
      it('should delete a Incidente', async () => {
